...
-   **AI Image Generation**: Integrates Seedream 4.0, 4o Image API, Flux Kontext, and Nano Banana for text-to-image and advanced editing with multi-image uploads. **4o Image API** features quantity-based pricing (1 image/6cr, 2 images/7cr, 4 images/8cr), supports aspect ratios 1:1/2:3/3:2, and image-to-image editing with mask support. All other models (Flux Kontext, Nano Banana, Seedream 4.0, Midjourney v7) support traditional quality/style/output format options.
