...
-   **AI Video Generation**: Supports Veo 3.1, Runway Aleph, Seedance Pro/Lite, Wan 2.5, Kling 2.5 Turbo, Grok Imagine, and Sora 2 Pro models with image-to-video capabilities. Model-specific aspect ratio and duration support with frontend filtering and backend validation. **Seedance Pro** features duration+resolution-based pricing with 6 pricing tiers (5s: 480p/70cr, 720p/150cr, 1080p/350cr | 10s: 480p/140cr, 720p/300cr, 1080p/700cr from Kie.ai), aspect ratio support (21:9, 16:9, 4:3, 1:1, 3:4, 9:16), 5s and 10s durations, camera-fixed toggle, and seed parameter. **Seedance Lite** features resolution-based pricing (480p/10 credits, 720p/22.5 credits, 1080p/50 credits from Kie.ai), aspect ratio support (16:9, 4:3, 1:1, 3:4, 9:16, 9:21), 10s duration only, camera-fixed toggle, and seed parameter. Both support proper image-to-video handling where aspect ratio is omitted (determined by input image). Database schema uses numeric type for decimal Kie.ai credit costs. Includes advanced features like Sora 2 Pro Storyboard for multi-scene videos.
