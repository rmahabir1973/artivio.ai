...
export default function LipSync() {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Success",
        description: "Lip sync generation started! Check below for updates.",
      });
    ...
    onError: (error: any) => {
      toast({
        title: "Error",
        description: error.message || "Failed to generate lip sync video",
        variant: "destructive",
      });
    },
  });
  ...
  const handleImageSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      toast({
        title: "Image Loaded",
        description: `${file.name} ready for lip sync`,
      });
    };
    reader.onerror = () => {
      setUploading(false);
  ...
  const handleAudioSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 50 * 1024 * 1024) {
      toast({
        title: "File Too Large",
        description: "Maximum audio size is 50MB.",
        variant: "destructive",
      });
      return;
    }
    ...
    reader.onload = (event) => {
      ...
      setRecordedAudio(null); // Clear recorded audio if file uploaded
      setUploading(false);
      toast({
        title: "Audio Loaded",
        description: `${file.name} ready for lip sync`,
        ...
        <div className="container mx-auto p-6 max-w-7xl space-y-6">
          ...
          <ThreeColumnLayout>
            ...
            <Card className="col-span-1">
              ...
              <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border-2 border-dashed rounded-lg p-4 text-center">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => document.querySelector('input[data-testid="input-audio-file"]')?.dispatchEvent(new MouseEvent("click"))}
                            disabled={uploading}
                          ...
                          {recordedAudio && (
                            <div className="space-y-2 border rounded p-3">
                              ...
                              <div className="flex gap-2">
                                ...
                                <Button onClick={clearRecording} size="sm" variant="destructive" className="flex-1" data-testid="button-clear-recording">
                                  Clear
                                </Button>
                              </div>
                              <div className="flex items-center gap-2">
                                ...
                                <Slider
                                  ...
                                  max={100}
                                  className="flex-1"
                                  data-testid="slider-recording-volume"
                                />
                              </div>
                            </div>
                          )}
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="e.g., Smile naturally, speak clearly, maintain eye contact"
                    value={prompt}
                    ...
                    <Card>
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-xs text-muted-foreground">
                          Use clear, front-facing images with good lighting. Avoid glasses or extreme angles.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-xs text-muted-foreground">
                          Ensure audio is clear and well-synchronized. Avoid background noise and gaps.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-xs text-muted-foreground">
                          Provide guidance on expressions and tone for more natural results.
                        </p>
                      </CardContent>
                    </Card>
                  </CollapsibleContent>
              ...
              <CardContent className="flex gap-2">
                <Button
                  ...
                  disabled={generateMutation.isPending || !imageUrl || !audioUrl}
                  className="w-full"
            ...
            <PreviewPanel
              ...
              type="video"
              isLoading={isLoading}
              isEmpty={generations.length === 0}
              emptyMessage="No lip-sync videos generated yet"
            />
          </ThreeColumnLayout>
                        ...
                        <CardContent>
                          {gen.status === "completed" && gen.resultUrl && (
                            <video
                              ...
                              data-testid={`video-result-${gen.id}`}
                            />
                          )}
