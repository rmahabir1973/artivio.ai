...
import { Loader2, Upload, X, Info, ArrowLeft, Presentation } from "lucide-react";
...
export default function Showcase() {
  ...
  const [prompt, setPrompt] = useState("Dynamic product showcase video with smooth 360-degree camera movement, professional studio lighting, and elegant transitions. The camera slowly orbits around the product, revealing every detail and angle with cinematic quality.");
  ...
  const creditCost = getModelCost('veo-3.1-fast', 400) || 200;
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      toast({
        ...
        description: "Your product showcase is being generated.",
      });
  ...
  useEffect(() => {
    ...
    if (isCompleted && pollData?.resultUrl) {
      ...
      toast({
        ...
        description: "Your product showcase is ready to view and download.",
      });
    } else if (isFailed) {
      setGeneratedVideo(pollData);
      setIsGenerating(false);
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="flex items-center gap-2">
                <Presentation className="h-5 w-5 text-yellow-500" />
                Product Showcase
              </CardTitle>
              <CardDescription>Create stunning 360-degree product showcase videos</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="bg-muted/50 rounded-md p-4 flex gap-3">
                <Info className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <p className="font-medium text-sm">Professional Product Videos</p>
                  <p className="text-sm text-muted-foreground">
                    Upload your product image and we'll create a dynamic showcase video with smooth camera movements and professional lighting effects.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">High-quality image-to-video</p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  placeholder="Describe how you want your product to be showcased..."
                  value={prompt}
              ...
              >
                {generateMutation.isPending || isGenerating ? (
                  ...
                  <>
                    ...
                    Generate Showcase ({creditCost} credits)
                  </>
                )}
              </Button>
