...
import SocialContentPlan from "@/pages/social/content-plan";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/social/oauth-callback" component={SocialOAuthCallback} />
      ...
      <Route path="/social/content-plan">
        <ProtectedRoute><SocialContentPlan /></ProtectedRoute>
      </Route>
