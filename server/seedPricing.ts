...
const COMPREHENSIVE_PRICING = [
  ...
  { feature: 'video', model: 'veo-3.1', creditCost: 500, kieCreditCost: 250, category: 'generation', description: 'Google Veo 3.1 - 1080p quality with synchronized audio (8s)' },
  ...
  { feature: 'video', model: 'runway-gen3-alpha-turbo', creditCost: 350, kieCreditCost: null, category: 'generation', description: 'Runway Gen-3 Alpha Turbo - Fast, high-quality (5s-10s)' },
  { feature: 'video', model: 'runway-aleph', creditCost: 400, kieCreditCost: null, category: 'generation', description: 'Runway Aleph - Advanced scene reasoning and camera control (5s-10s)' },
  ...
  // TOPAZ AI UPSCALING
  // ========================================
  // Hypothetical feature - not yet integrated with Kie.ai, no kieCreditCost
  ...
  { feature: 'upscaling', model: 'topaz-video-2x', creditCost: 80, kieCreditCost: null, category: 'enhancement', description: 'Topaz Video Upscale 2x (HD enhancement)' },
  { feature: 'upscaling', model: 'topaz-video-4x', creditCost: 150, kieCreditCost: null, category: 'enhancement', description: 'Topaz Video Upscale 4x (4K enhancement)' },
