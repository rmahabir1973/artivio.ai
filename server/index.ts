...
const cspDirectives = [
  ...
  `script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://js.stripe.com https://www.googletagmanager.com https://accounts.google.com https://www.google.com https://challenges.cloudflare.com${isDevelopment ? " http://localhost:* ws://localhost:*" : ""}`,
